...
export const getTasks = () => {
  console.log("🔵 Frontend: Calling GET /api/tasks");
  return api.get("/tasks");
};

export const createTask = (data) => {
  console.log("🔵 Frontend: Calling POST /api/tasks with data:", data);
  return api.post("/tasks", data);
};

export const updateTask = (id, data) => {
  console.log("🔵 Frontend: Calling PUT /api/tasks/" + id + " with data:", data);
  return api.put(`/tasks/${id}`, data);
};

export const deleteTask = (id) => {
  console.log("🔵 Frontend: Calling DELETE /api/tasks/" + id);
